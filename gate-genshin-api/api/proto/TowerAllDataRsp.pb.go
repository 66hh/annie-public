...
type TowerAllDataRsp struct {
	...
	TowerFloorRecordList          []*TowerFloorRecord  `protobuf:"bytes,12,rep,name=tower_floor_record_list,json=towerFloorRecordList,proto3" json:"tower_floor_record_list,omitempty"`
	DailyFloorId                  uint32               `protobuf:"varint,9,opt,name=daily_floor_id,json=dailyFloorId,proto3" json:"daily_floor_id,omitempty"`
	DailyLevelIndex               uint32               `protobuf:"varint,6,opt,name=daily_level_index,json=dailyLevelIndex,proto3" json:"daily_level_index,omitempty"`
	CurLevelRecord                *TowerCurLevelRecord `protobuf:"bytes,2,opt,name=cur_level_record,json=curLevelRecord,proto3" json:"cur_level_record,omitempty"`
	...
	FloorOpenTimeMap              map[uint32]uint32    `protobuf:"bytes,11,rep,name=floor_open_time_map,json=floorOpenTimeMap,proto3" json:"floor_open_time_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	IsFirstInteract               bool                 `protobuf:"varint,14,opt,name=is_first_interact,json=isFirstInteract,proto3" json:"is_first_interact,omitempty"`
	...
	SkipToFloorIndex              uint32               `protobuf:"varint,3,opt,name=skip_to_floor_index,json=skipToFloorIndex,proto3" json:"skip_to_floor_index,omitempty"`
	CommemorativeRewardId         uint32               `protobuf:"varint,15,opt,name=commemorative_reward_id,json=commemorativeRewardId,proto3" json:"commemorative_reward_id,omitempty"`
	SkipFloorGrantedRewardItemMap map[uint32]uint32    `protobuf:"bytes,5,rep,name=skip_floor_granted_reward_item_map,json=skipFloorGrantedRewardItemMap,proto3" json:"skip_floor_granted_reward_item_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	ValidTowerRecordNum           uint32               `protobuf:"varint,10,opt,name=valid_tower_record_num,json=validTowerRecordNum,proto3" json:"valid_tower_record_num,omitempty"`
	Retcode                       int32                `protobuf:"varint,4,opt,name=retcode,proto3" json:"retcode,omitempty"`
	IsFinishedEntranceFloor       bool                 `protobuf:"varint,7,opt,name=is_finished_entrance_floor,json=isFinishedEntranceFloor,proto3" json:"is_finished_entrance_floor,omitempty"`
	ScheduleStartTime             uint32               `protobuf:"varint,490,opt,name=schedule_start_time,json=scheduleStartTime,proto3" json:"schedule_start_time,omitempty"`
	LastScheduleMonthlyBrief      *TowerMonthlyBrief   `protobuf:"bytes,395,opt,name=last_schedule_monthly_brief,json=lastScheduleMonthlyBrief,proto3" json:"last_schedule_monthly_brief,omitempty"`
}
...
var file_TowerAllDataRsp_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x74, 0x6f, 0x77, 0x65, 0x72,
	...
	0x69, 0x6c, 0x79, 0x5f, 0x66, 0x6c, 0x6f, 0x6f, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01,
	...
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x64, 0x61, 0x69,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x54,
	...
	0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x16, 0x6e, 0x65, 0x78, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64,
	...
	0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x73, 0x46, 0x69, 0x72, 0x73, 0x74, 0x49, 0x6e,
	0x74, 0x65, 0x72, 0x61, 0x63, 0x74, 0x12, 0x3d, 0x0a, 0x0d, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x6c,
	0x79, 0x5f, 0x62, 0x72, 0x69, 0x65, 0x66, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	0x5f, 0x66, 0x6c, 0x6f, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01,
	...
	0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x15, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x61,
	...
	0x6d, 0x61, 0x70, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x65, 0x72, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x0a, 0x20,
	...
	,
	...
	0x50, 0x0a, 0x22, 0x53, 0x6b, 0x69, 0x70, 0x46, 0x6c, 0x6f, 0x6f, 0x72, 0x47, 0x72, 0x61, 0x6e,
...
var file_TowerAllDataRsp_proto_goTypes = []interface{}{
	...
	nil,                         // 1: proto.TowerAllDataRsp.FloorOpenTimeMapEntry
	nil,                         // 2: proto.TowerAllDataRsp.SkipFloorGrantedRewardItemMapEntry
	(*TowerFloorRecord)(nil),    // 3: proto.TowerFloorRecord
	(*TowerCurLevelRecord)(nil), // 4: proto.TowerCurLevelRecord
	(*TowerMonthlyBrief)(nil),   // 5: proto.TowerMonthlyBrief
}
var file_TowerAllDataRsp_proto_depIdxs = []int32{
	3, // 0: proto.TowerAllDataRsp.tower_floor_record_list:type_name -> proto.TowerFloorRecord
	4, // 1: proto.TowerAllDataRsp.cur_level_record:type_name -> proto.TowerCurLevelRecord
	1, // 2: proto.TowerAllDataRsp.floor_open_time_map:type_name -> proto.TowerAllDataRsp.FloorOpenTimeMapEntry
	5, // 3: proto.TowerAllDataRsp.monthly_brief:type_name -> proto.TowerMonthlyBrief
	2, // 4: proto.TowerAllDataRsp.skip_floor_granted_reward_item_map:type_name -> proto.TowerAllDataRsp.SkipFloorGrantedRewardItemMapEntry
	5, // 5: proto.TowerAllDataRsp.last_schedule_monthly_brief:type_name -> proto.TowerMonthlyBrief
