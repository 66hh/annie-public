...
const (
	...
	AvatarChangeCostumeNotify_CMD_ID           AvatarChangeCostumeNotify_CmdId = 1724
)
...
func (AvatarChangeCostumeNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_AvatarChangeCostumeNotify_proto_enumTypes[0].Descriptor()
}

func (AvatarChangeCostumeNotify_CmdId) Type() protoreflect.EnumType {
	return &file_AvatarChangeCostumeNotify_proto_enumTypes[0]
}
...
func (AvatarChangeCostumeNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_AvatarChangeCostumeNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type AvatarChangeCostumeNotify struct {
	...
	EntityInfo *SceneEntityInfo `protobuf:"bytes,1,opt,name=entity_info,json=entityInfo,proto3" json:"entity_info,omitempty"`
}
...
var file_AvatarChangeCostumeNotify_proto_rawDesc = []byte{
	...
	0xa3, 0x01, 0x0a, 0x19, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	0x43, 0x6f, 0x73, 0x74, 0x75, 0x6d, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x37, 0x0a,
	0x0b, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01,
	...
	0x74, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12,
	...
	0x4c, 0x45, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xbc,
	0x0d, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74,
...
var file_AvatarChangeCostumeNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_AvatarChangeCostumeNotify_proto_goTypes = []interface{}{
	(AvatarChangeCostumeNotify_CmdId)(0), // 0: proto.AvatarChangeCostumeNotify.CmdId
	(*AvatarChangeCostumeNotify)(nil),    // 1: proto.AvatarChangeCostumeNotify
	(*SceneEntityInfo)(nil),              // 2: proto.SceneEntityInfo
}
var file_AvatarChangeCostumeNotify_proto_depIdxs = []int32{
	2, // 0: proto.AvatarChangeCostumeNotify.entity_info:type_name -> proto.SceneEntityInfo
...
func file_AvatarChangeCostumeNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_AvatarChangeCostumeNotify_proto_enumTypes,
