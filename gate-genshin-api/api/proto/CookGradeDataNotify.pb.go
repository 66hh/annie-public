...
type CookGradeDataNotify struct {
	...
	Grade uint32 `protobuf:"varint,6,opt,name=grade,proto3" json:"grade,omitempty"`
}
...
var file_CookGradeDataNotify_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x67, 0x72, 0x61, 0x64, 0x65, 0x42,
