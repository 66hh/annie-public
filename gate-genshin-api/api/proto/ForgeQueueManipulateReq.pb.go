...
type ForgeQueueManipulateReq struct {
	...
	ForgeQueueId   uint32                   `protobuf:"varint,11,opt,name=forge_queue_id,json=forgeQueueId,proto3" json:"forge_queue_id,omitempty"`
	ManipulateType ForgeQueueManipulateType `protobuf:"varint,7,opt,name=manipulate_type,json=manipulateType,proto3,enum=proto.ForgeQueueManipulateType" json:"manipulate_type,omitempty"`
}
...
var file_ForgeQueueManipulateReq_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x66, 0x6f, 0x72, 0x67,
	0x65, 0x51, 0x75, 0x65, 0x75, 0x65, 0x49, 0x64, 0x12, 0x48, 0x0a, 0x0f, 0x6d, 0x61, 0x6e, 0x69,
	0x70, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28,
