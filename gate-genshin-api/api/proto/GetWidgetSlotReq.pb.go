...
const (
	...
	GetWidgetSlotReq_CMD_ID           GetWidgetSlotReq_CmdId = 4274
)
...
func (GetWidgetSlotReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetWidgetSlotReq_proto_enumTypes[0].Descriptor()
}

func (GetWidgetSlotReq_CmdId) Type() protoreflect.EnumType {
	return &file_GetWidgetSlotReq_proto_enumTypes[0]
}
...
func (GetWidgetSlotReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetWidgetSlotReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_GetWidgetSlotReq_proto_rawDesc = []byte{
	...
	0x76, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74, 0x53, 0x6c, 0x6f, 0x74,
	...
	0x10, 0xb2, 0x21, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72,
...
var file_GetWidgetSlotReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_GetWidgetSlotReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_GetWidgetSlotReq_proto_goTypes = []interface{}{
	(GetWidgetSlotReq_CmdId)(0), // 0: proto.GetWidgetSlotReq.CmdId
	(*GetWidgetSlotReq)(nil),    // 1: proto.GetWidgetSlotReq
}
...
func file_GetWidgetSlotReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetWidgetSlotReq_proto_enumTypes,
