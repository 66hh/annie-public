...
type GetActivityInfoReq struct {
	...
	ActivityIdList []uint32 `protobuf:"varint,14,rep,packed,name=activity_id_list,json=activityIdList,proto3" json:"activity_id_list,omitempty"`
}
...
var file_GetActivityInfoReq_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20, 0x03, 0x28,
