...
type WidgetCreatorInfo struct {
	...
	OpType       WidgetCreatorOpType       `protobuf:"varint,11,opt,name=op_type,json=opType,proto3,enum=proto.WidgetCreatorOpType" json:"op_type,omitempty"`
	EntityId     uint32                    `protobuf:"varint,8,opt,name=entity_id,json=entityId,proto3" json:"entity_id,omitempty"`
	LocationInfo *WidgetCreateLocationInfo `protobuf:"bytes,10,opt,name=location_info,json=locationInfo,proto3" json:"location_info,omitempty"`
}
...
var file_WidgetCreatorInfo_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x33, 0x0a, 0x07, 0x6f, 0x70, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0b, 0x20, 0x01,
	...
	0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x70, 0x72, 0x6f,
