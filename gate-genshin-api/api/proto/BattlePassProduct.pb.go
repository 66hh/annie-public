...
type BattlePassProduct struct {
	...
	NormalProductId  string `protobuf:"bytes,8,opt,name=normal_product_id,json=normalProductId,proto3" json:"normal_product_id,omitempty"`
	ExtraProductId   string `protobuf:"bytes,4,opt,name=extra_product_id,json=extraProductId,proto3" json:"extra_product_id,omitempty"`
	UpgradeProductId string `protobuf:"bytes,14,opt,name=upgrade_product_id,json=upgradeProductId,proto3" json:"upgrade_product_id,omitempty"`
}
...
var file_BattlePassProduct_proto_rawDesc = []byte{
	...
	0x75, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x65, 0x78,
	...
	0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x75, 0x70, 0x67, 0x72, 0x61, 0x64,
