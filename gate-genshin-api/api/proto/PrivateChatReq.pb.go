...
const (
	...
	PrivateChatReq_CMD_ID           PrivateChatReq_CmdId = 4999
)
...
func (PrivateChatReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_PrivateChatReq_proto_enumTypes[0].Descriptor()
}

func (PrivateChatReq_CmdId) Type() protoreflect.EnumType {
	return &file_PrivateChatReq_proto_enumTypes[0]
}
...
func (PrivateChatReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_PrivateChatReq_proto_rawDescGZIP(), []int{0, 0}
}
...
type PrivateChatReq_Icon struct {
	Icon uint32 `protobuf:"varint,3,opt,name=icon,proto3,oneof"`
}
...
var file_PrivateChatReq_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xca, 0x01,
	...
	0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x12, 0x14, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x87, 0x27, 0x1a, 0x02, 0x10, 0x01, 0x42,
	0x09, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f,
...
var file_PrivateChatReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_PrivateChatReq_proto_goTypes = []interface{}{
	...
	(*PrivateChatReq)(nil),    // 1: proto.PrivateChatReq
}
...
func file_PrivateChatReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_PrivateChatReq_proto_enumTypes,
