...
type MotionInfo struct {
	...
	IntervalVelocity uint32      `protobuf:"varint,9,opt,name=interval_velocity,json=intervalVelocity,proto3" json:"interval_velocity,omitempty"`
}
...
func (x *MotionInfo) GetIntervalVelocity() uint32 {
	if x != nil {
...
var file_MotionInfo_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x02, 0x0a, 0x0a, 0x4d,
	...
	0x63, 0x69, 0x74, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x69, 0x6e, 0x74, 0x65,
