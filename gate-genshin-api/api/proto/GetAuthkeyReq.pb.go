...
const (
	...
	GetAuthkeyReq_CMD_ID           GetAuthkeyReq_CmdId = 1435
)
...
type GetAuthkeyReq struct {
	...
	AuthAppid  string `protobuf:"bytes,12,opt,name=auth_appid,json=authAppid,proto3" json:"auth_appid,omitempty"`
	SignType   uint32 `protobuf:"varint,15,opt,name=sign_type,json=signType,proto3" json:"sign_type,omitempty"`
	AuthkeyVer uint32 `protobuf:"varint,7,opt,name=authkey_ver,json=authkeyVer,proto3" json:"authkey_ver,omitempty"`
}
...
var file_GetAuthkeyReq_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x61, 0x70, 0x70, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01,
	...
	0x74, 0x68, 0x6b, 0x65, 0x79, 0x5f, 0x76, 0x65, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x9b, 0x0b, 0x1a, 0x02, 0x10, 0x01, 0x42,
