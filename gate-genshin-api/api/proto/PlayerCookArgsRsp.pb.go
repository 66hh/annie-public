...
type PlayerCookArgsRsp struct {
	...
	QteRangeRatio float32 `protobuf:"fixed32,15,opt,name=qte_range_ratio,json=qteRangeRatio,proto3" json:"qte_range_ratio,omitempty"`
}
...
var file_PlayerCookArgsRsp_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0d, 0x71, 0x74, 0x65, 0x52, 0x61, 0x6e,
