...
const (
	...
	CombineDataNotify_CMD_ID           CombineDataNotify_CmdId = 657
)
...
func (CombineDataNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_CombineDataNotify_proto_enumTypes[0].Descriptor()
}

func (CombineDataNotify_CmdId) Type() protoreflect.EnumType {
	return &file_CombineDataNotify_proto_enumTypes[0]
}
...
func (CombineDataNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_CombineDataNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type CombineDataNotify struct {
	...
	CombineIdList []uint32 `protobuf:"varint,1,rep,packed,name=combine_id_list,json=combineIdList,proto3" json:"combine_id_list,omitempty"`
}
...
var file_CombineDataNotify_proto_rawDesc = []byte{
	...
	0x22, 0x8a, 0x01, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x44, 0x61, 0x74, 0x61,
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x26, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x62, 0x69, 0x6e,
	0x65, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52,
	0x0d, 0x63, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x4d,
	...
	0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x91, 0x05, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a,
...
var file_CombineDataNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_CombineDataNotify_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_CombineDataNotify_proto_goTypes = []interface{}{
	(CombineDataNotify_CmdId)(0), // 0: proto.CombineDataNotify.CmdId
	(*CombineDataNotify)(nil),    // 1: proto.CombineDataNotify
}
...
func file_CombineDataNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_CombineDataNotify_proto_enumTypes,
