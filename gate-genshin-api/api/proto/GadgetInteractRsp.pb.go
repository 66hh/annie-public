...
type GadgetInteractRsp struct {
	...
	InteractType   InteractType `protobuf:"varint,9,opt,name=interact_type,json=interactType,proto3,enum=proto.InteractType" json:"interact_type,omitempty"`
	OpType         InterOpType  `protobuf:"varint,1,opt,name=op_type,json=opType,proto3,enum=proto.InterOpType" json:"op_type,omitempty"`
...
var file_GadgetInteractRsp_proto_rawDesc = []byte{
	...
	0x70, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x70,
	...
	0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x67, 0x61, 0x64,
