...
type BuyBattlePassLevelReq struct {
	...
	BuyLevel uint32 `protobuf:"varint,10,opt,name=buy_level,json=buyLevel,proto3" json:"buy_level,omitempty"`
}
...
var file_BuyBattlePassLevelReq_proto_rawDesc = []byte{
	...
	0x09, 0x62, 0x75, 0x79, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d,
