...
type HomeMarkPointNotify struct {
	...
	MarkPointDataList []*HomeMarkPointSceneData `protobuf:"bytes,13,rep,name=mark_point_data_list,json=markPointDataList,proto3" json:"mark_point_data_list,omitempty"`
}
...
var file_HomeMarkPointNotify_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x48, 0x6f,
