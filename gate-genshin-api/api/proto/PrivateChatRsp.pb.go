...
const (
	...
	PrivateChatRsp_CMD_ID           PrivateChatRsp_CmdId = 4981
)
...
func (PrivateChatRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_PrivateChatRsp_proto_enumTypes[0].Descriptor()
}

func (PrivateChatRsp_CmdId) Type() protoreflect.EnumType {
	return &file_PrivateChatRsp_proto_enumTypes[0]
}
...
func (PrivateChatRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_PrivateChatRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
type PrivateChatRsp struct {
	...
	ChatForbiddenEndtime uint32 `protobuf:"varint,10,opt,name=chat_forbidden_endtime,json=chatForbiddenEndtime,proto3" json:"chat_forbidden_endtime,omitempty"`
}
...
var file_PrivateChatRsp_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaf, 0x01,
	0x0a, 0x0e, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x73, 0x70,
	0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x34, 0x0a, 0x16, 0x63, 0x68,
	0x61, 0x74, 0x5f, 0x66, 0x6f, 0x72, 0x62, 0x69, 0x64, 0x64, 0x65, 0x6e, 0x5f, 0x65, 0x6e, 0x64,
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x14, 0x63, 0x68, 0x61, 0x74,
	...
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xf5, 0x26, 0x1a, 0x02, 0x10, 0x01, 0x42,
...
var file_PrivateChatRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_PrivateChatRsp_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_PrivateChatRsp_proto_goTypes = []interface{}{
	(PrivateChatRsp_CmdId)(0), // 0: proto.PrivateChatRsp.CmdId
...
func file_PrivateChatRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_PrivateChatRsp_proto_enumTypes,
