...
type ForgeQueueManipulateRsp struct {
	...
	ManipulateType      ForgeQueueManipulateType `protobuf:"varint,8,opt,name=manipulate_type,json=manipulateType,proto3,enum=proto.ForgeQueueManipulateType" json:"manipulate_type,omitempty"`
...
var file_ForgeQueueManipulateRsp_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x46,
	...
	0x74, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28,
...
var file_ForgeQueueManipulateRsp_proto_depIdxs = []int32{
	...
	2, // 1: proto.ForgeQueueManipulateRsp.output_item_list:type_name -> proto.ItemParam
	2, // 2: proto.ForgeQueueManipulateRsp.return_item_list:type_name -> proto.ItemParam
	2, // 3: proto.ForgeQueueManipulateRsp.extra_output_item_list:type_name -> proto.ItemParam
