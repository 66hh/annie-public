...
type FoundationInfo struct {
	...
	BeginBuildTimeMs  uint64           `protobuf:"varint,4,opt,name=begin_build_time_ms,json=beginBuildTimeMs,proto3" json:"begin_build_time_ms,omitempty"`
...
func (x *FoundationInfo) GetBeginBuildTimeMs() uint64 {
	if x != nil {
...
var file_FoundationInfo_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x62, 0x65, 0x67, 0x69, 0x6e, 0x42, 0x75, 0x69, 0x6c,
