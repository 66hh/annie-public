...
type ShortAbilityHashPair struct {
	...
	AbilityNameHash   int32 `protobuf:"varint,1,opt,name=ability_name_hash,json=abilityNameHash,proto3" json:"ability_name_hash,omitempty"`
	AbilityConfigHash int32 `protobuf:"varint,2,opt,name=ability_config_hash,json=abilityConfigHash,proto3" json:"ability_config_hash,omitempty"`
}
...
var file_ShortAbilityHashPair_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4e,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x11, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x43, 0x6f, 0x6e,
