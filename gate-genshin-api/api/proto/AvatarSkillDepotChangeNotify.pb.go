...
type AvatarSkillDepotChangeNotify struct {
	...
	CoreProudSkillLevel     uint32            `protobuf:"varint,4,opt,name=core_proud_skill_level,json=coreProudSkillLevel,proto3" json:"core_proud_skill_level,omitempty"`
	SkillLevelMap           map[uint32]uint32 `protobuf:"bytes,10,rep,name=skill_level_map,json=skillLevelMap,proto3" json:"skill_level_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	ProudSkillExtraLevelMap map[uint32]uint32 `protobuf:"bytes,11,rep,name=proud_skill_extra_level_map,json=proudSkillExtraLevelMap,proto3" json:"proud_skill_extra_level_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_AvatarSkillDepotChangeNotify_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0c, 0x74, 0x61, 0x6c, 0x65, 0x6e, 0x74,
	...
	0x65, 0x76, 0x65, 0x6c, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x36,
	...
	0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x70, 0x72, 0x6f,
...
var file_AvatarSkillDepotChangeNotify_proto_goTypes = []interface{}{
	...
	nil,                                  // 1: proto.AvatarSkillDepotChangeNotify.SkillLevelMapEntry
	nil,                                  // 2: proto.AvatarSkillDepotChangeNotify.ProudSkillExtraLevelMapEntry
}
var file_AvatarSkillDepotChangeNotify_proto_depIdxs = []int32{
	1, // 0: proto.AvatarSkillDepotChangeNotify.skill_level_map:type_name -> proto.AvatarSkillDepotChangeNotify.SkillLevelMapEntry
	2, // 1: proto.AvatarSkillDepotChangeNotify.proud_skill_extra_level_map:type_name -> proto.AvatarSkillDepotChangeNotify.ProudSkillExtraLevelMapEntry
