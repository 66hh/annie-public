...
type PlayerCookRsp struct {
	...
	RecipeData     *CookRecipeData `protobuf:"bytes,14,opt,name=recipe_data,json=recipeData,proto3" json:"recipe_data,omitempty"`
	ItemList       []*ItemParam    `protobuf:"bytes,13,rep,name=item_list,json=itemList,proto3" json:"item_list,omitempty"`
	QteQuality     uint32          `protobuf:"varint,11,opt,name=qte_quality,json=qteQuality,proto3" json:"qte_quality,omitempty"`
	CookCount      uint32          `protobuf:"varint,15,opt,name=cook_count,json=cookCount,proto3" json:"cook_count,omitempty"`
	ExtralItemList []*ItemParam    `protobuf:"bytes,3,rep,name=extral_item_list,json=extralItemList,proto3" json:"extral_item_list,omitempty"`
}
...
var file_PlayerCookRsp_proto_rawDesc = []byte{
	...
	0x36, 0x0a, 0x0b, 0x72, 0x65, 0x63, 0x69, 0x70, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0e,
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x61, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x71, 0x74, 0x65,
	0x51, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6f, 0x6f, 0x6b, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x63, 0x6f, 0x6f,
	0x6b, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x3a, 0x0a, 0x10, 0x65, 0x78, 0x74, 0x72, 0x61, 0x6c,
	...
	0x61, 0x6d, 0x52, 0x0e, 0x65, 0x78, 0x74, 0x72, 0x61, 0x6c, 0x49, 0x74, 0x65, 0x6d, 0x4c, 0x69,
...
var file_PlayerCookRsp_proto_depIdxs = []int32{
	1, // 0: proto.PlayerCookRsp.recipe_data:type_name -> proto.CookRecipeData
	2, // 1: proto.PlayerCookRsp.item_list:type_name -> proto.ItemParam
	2, // 2: proto.PlayerCookRsp.extral_item_list:type_name -> proto.ItemParam
