...
const (
	...
	EvtAiSyncSkillCdNotify_CMD_ID           EvtAiSyncSkillCdNotify_CmdId = 333
)
...
type EvtAiSyncSkillCdNotify struct {
	...
	AiCdMap map[uint32]*AiSkillCdInfo `protobuf:"bytes,5,rep,name=ai_cd_map,json=aiCdMap,proto3" json:"ai_cd_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_EvtAiSyncSkillCdNotify_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x10, 0x01, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xcd, 0x02, 0x1a,
