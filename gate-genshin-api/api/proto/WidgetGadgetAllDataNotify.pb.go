...
type WidgetGadgetAllDataNotify struct {
	...
	WidgetGadgetData []*WidgetGadgetData `protobuf:"bytes,8,rep,name=widget_gadget_data,json=widgetGadgetData,proto3" json:"widget_gadget_data,omitempty"`
}
...
var file_WidgetGadgetAllDataNotify_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x74,
