...
const (
	...
	ItemAddHintNotify_CMD_ID           ItemAddHintNotify_CmdId = 700
)
...
type ItemAddHintNotify struct {
	...
	IsTransferedFromAvatarCard  bool        `protobuf:"varint,6,opt,name=is_transfered_from_avatar_card,json=isTransferedFromAvatarCard,proto3" json:"is_transfered_from_avatar_card,omitempty"`
	OverflowTransformedItemList []*ItemHint `protobuf:"bytes,7,rep,name=overflow_transformed_item_list,json=overflowTransformedItemList,proto3" json:"overflow_transformed_item_list,omitempty"`
	IsGeneralRewardHiden        bool        `protobuf:"varint,8,opt,name=is_general_reward_hiden,json=isGeneralRewardHiden,proto3" json:"is_general_reward_hiden,omitempty"`
}
...
var file_ItemAddHintNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x5f, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x63, 0x61, 0x72, 0x64, 0x18, 0x06,
	...
	0x73, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x14, 0x69, 0x73, 0x47, 0x65, 0x6e, 0x65, 0x72,
	...
	0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xbc, 0x05, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08,
