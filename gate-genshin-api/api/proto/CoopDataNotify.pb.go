...
const (
	...
	CoopDataNotify_CMD_ID           CoopDataNotify_CmdId = 1976
)
...
type CoopDataNotify struct {
	...
	ChapterList       []*CoopChapter `protobuf:"bytes,13,rep,name=chapter_list,json=chapterList,proto3" json:"chapter_list,omitempty"`
	IsHaveProgress    bool           `protobuf:"varint,14,opt,name=is_have_progress,json=isHaveProgress,proto3" json:"is_have_progress,omitempty"`
	CurCoopPoint      uint32         `protobuf:"varint,5,opt,name=cur_coop_point,json=curCoopPoint,proto3" json:"cur_coop_point,omitempty"`
	ViewedChapterList []uint32       `protobuf:"varint,2,rep,packed,name=viewed_chapter_list,json=viewedChapterList,proto3" json:"viewed_chapter_list,omitempty"`
}
...
var file_CoopDataNotify_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x5f, 0x68, 0x61, 0x76, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x0e,
	...
	0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x11, 0x76, 0x69, 0x65, 0x77, 0x65, 0x64, 0x43,
	...
	0x49, 0x44, 0x10, 0xb8, 0x0f, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b,
