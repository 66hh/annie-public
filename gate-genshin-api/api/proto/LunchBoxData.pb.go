...
type LunchBoxData struct {
	...
	SlotMaterialMap map[uint32]uint32 `protobuf:"bytes,5,rep,name=slot_material_map,json=slotMaterialMap,proto3" json:"slot_material_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_LunchBoxData_proto_rawDesc = []byte{
	...
	0x70, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
