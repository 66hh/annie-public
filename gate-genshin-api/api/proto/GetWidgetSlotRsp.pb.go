...
const (
	...
	GetWidgetSlotRsp_CMD_ID           GetWidgetSlotRsp_CmdId = 4267
)
...
func (GetWidgetSlotRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetWidgetSlotRsp_proto_enumTypes[0].Descriptor()
}

func (GetWidgetSlotRsp_CmdId) Type() protoreflect.EnumType {
	return &file_GetWidgetSlotRsp_proto_enumTypes[0]
}
...
func (GetWidgetSlotRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetWidgetSlotRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
type GetWidgetSlotRsp struct {
	...
	SlotList []*WidgetSlotData `protobuf:"bytes,8,rep,name=slot_list,json=slotList,proto3" json:"slot_list,omitempty"`
}
...
var file_GetWidgetSlotRsp_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaf, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x57, 0x69, 0x64,
	0x67, 0x65, 0x74, 0x53, 0x6c, 0x6f, 0x74, 0x52, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65,
	0x74, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x72, 0x65, 0x74,
	0x63, 0x6f, 0x64, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x73, 0x6c, 0x6f, 0x74, 0x5f, 0x6c, 0x69, 0x73,
	...
	0x73, 0x6c, 0x6f, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49,
	...
	0x10, 0xab, 0x21, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72,
...
var file_GetWidgetSlotRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_GetWidgetSlotRsp_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_GetWidgetSlotRsp_proto_goTypes = []interface{}{
	(GetWidgetSlotRsp_CmdId)(0), // 0: proto.GetWidgetSlotRsp.CmdId
	(*GetWidgetSlotRsp)(nil),    // 1: proto.GetWidgetSlotRsp
	(*WidgetSlotData)(nil),      // 2: proto.WidgetSlotData
}
var file_GetWidgetSlotRsp_proto_depIdxs = []int32{
	2, // 0: proto.GetWidgetSlotRsp.slot_list:type_name -> proto.WidgetSlotData
...
func file_GetWidgetSlotRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetWidgetSlotRsp_proto_enumTypes,
