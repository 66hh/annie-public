...
type TowerMonthlyBrief struct {
	...
	TowerScheduleId uint32 `protobuf:"varint,4,opt,name=tower_schedule_id,json=towerScheduleId,proto3" json:"tower_schedule_id,omitempty"`
	BestFloorIndex  uint32 `protobuf:"varint,5,opt,name=best_floor_index,json=bestFloorIndex,proto3" json:"best_floor_index,omitempty"`
	BestLevelIndex  uint32 `protobuf:"varint,12,opt,name=best_level_index,json=bestLevelIndex,proto3" json:"best_level_index,omitempty"`
	TotalStarCount  uint32 `protobuf:"varint,2,opt,name=total_star_count,json=totalStarCount,proto3" json:"total_star_count,omitempty"`
}
...
var file_TowerMonthlyBrief_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x62, 0x65,
	...
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x62, 0x65, 0x73, 0x74, 0x4c, 0x65, 0x76, 0x65,
