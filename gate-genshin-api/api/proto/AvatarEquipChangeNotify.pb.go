...
type AvatarEquipChangeNotify struct {
	...
	Weapon     *SceneWeaponInfo    `protobuf:"bytes,13,opt,name=weapon,proto3" json:"weapon,omitempty"`
	Reliquary  *SceneReliquaryInfo `protobuf:"bytes,11,opt,name=reliquary,proto3" json:"reliquary,omitempty"`
}
...
var file_AvatarEquipChangeNotify_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x70, 0x6f, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x72,
	...
	0x65, 0x6c, 0x69, 0x71, 0x75, 0x61, 0x72, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19,
	...
	0x75, 0x61, 0x72, 0x79, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_AvatarEquipChangeNotify_proto_goTypes = []interface{}{
	...
	(*SceneWeaponInfo)(nil),         // 1: proto.SceneWeaponInfo
	(*SceneReliquaryInfo)(nil),      // 2: proto.SceneReliquaryInfo
}
var file_AvatarEquipChangeNotify_proto_depIdxs = []int32{
	1, // 0: proto.AvatarEquipChangeNotify.weapon:type_name -> proto.SceneWeaponInfo
	2, // 1: proto.AvatarEquipChangeNotify.reliquary:type_name -> proto.SceneReliquaryInfo
