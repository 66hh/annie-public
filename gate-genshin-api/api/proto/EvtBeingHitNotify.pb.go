...
const (
	...
	EvtBeingHitNotify_CMD_ID           EvtBeingHitNotify_CmdId = 309
)
...
type EvtBeingHitNotify struct {
	...
	BeingHitInfo *EvtBeingHitInfo `protobuf:"bytes,7,opt,name=being_hit_info,json=beingHitInfo,proto3" json:"being_hit_info,omitempty"`
}
...
var file_EvtBeingHitNotify_proto_rawDesc = []byte{
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x46,
	...
	0x5f, 0x68, 0x69, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x49, 0x44, 0x10, 0xb5, 0x02, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b,
