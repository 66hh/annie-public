...
type CombatInvocationsNotify struct {
	...
	InvokeList []*CombatInvokeEntry `protobuf:"bytes,4,rep,name=invoke_list,json=invokeList,proto3" json:"invoke_list,omitempty"`
}
...
var file_CombatInvocationsNotify_proto_rawDesc = []byte{
	...
	0x76, 0x6f, 0x6b, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32,
