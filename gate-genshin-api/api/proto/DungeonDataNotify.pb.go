...
type DungeonDataNotify struct {
	...
	DungeonDataMap map[uint32]uint32 `protobuf:"bytes,6,rep,name=dungeon_data_map,json=dungeonDataMap,proto3" json:"dungeon_data_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_DungeonDataNotify_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b,
