...
type ChapterStateNotify struct {
	...
	ChapterState    ChapterState                        `protobuf:"varint,12,opt,name=chapter_state,json=chapterState,proto3,enum=proto.ChapterState" json:"chapter_state,omitempty"`
	...
	NeedBeginTime   *ChapterStateNotify_NeedBeginTime   `protobuf:"bytes,14,opt,name=need_begin_time,json=needBeginTime,proto3" json:"need_begin_time,omitempty"`
}
...
type ChapterStateNotify_NeedPlayerLevel struct {
	...
	ConfigNeedPlayerLevel uint32 `protobuf:"varint,10,opt,name=config_need_player_level,json=configNeedPlayerLevel,proto3" json:"config_need_player_level,omitempty"`
}
...
type ChapterStateNotify_NeedBeginTime struct {
	...
	IsLimit             bool   `protobuf:"varint,13,opt,name=is_limit,json=isLimit,proto3" json:"is_limit,omitempty"`
	ConfigNeedBeginTime uint32 `protobuf:"varint,6,opt,name=config_need_begin_time,json=configNeedBeginTime,proto3" json:"config_need_begin_time,omitempty"`
}
...
var file_ChapterStateNotify_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x70, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0c, 0x20, 0x01,
	...
	0x61, 0x79, 0x65, 0x72, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b,
	...
	0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x43, 0x68,
	...
	0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x03, 0x20, 0x01,
	...
	0x72, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x15, 0x63,
	...
	0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x4c, 0x69, 0x6d, 0x69, 0x74,
