...
const (
	...
	GetPlayerAskFriendListRsp_CMD_ID           GetPlayerAskFriendListRsp_CmdId = 4004
)
...
func (GetPlayerAskFriendListRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetPlayerAskFriendListRsp_proto_enumTypes[0].Descriptor()
}

func (GetPlayerAskFriendListRsp_CmdId) Type() protoreflect.EnumType {
	return &file_GetPlayerAskFriendListRsp_proto_enumTypes[0]
}
...
func (GetPlayerAskFriendListRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetPlayerAskFriendListRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_GetPlayerAskFriendListRsp_proto_rawDesc = []byte{
	...
	0x42, 0x72, 0x69, 0x65, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc0, 0x01, 0x0a, 0x19,
	0x47, 0x65, 0x74, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x41, 0x73, 0x6b, 0x46, 0x72, 0x69, 0x65,
	...
	0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x42, 0x72, 0x69, 0x65, 0x66,
	0x52, 0x0d, 0x61, 0x73, 0x6b, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22,
	...
	0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xa4, 0x1f, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a,
...
var file_GetPlayerAskFriendListRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_GetPlayerAskFriendListRsp_proto_goTypes = []interface{}{
	(GetPlayerAskFriendListRsp_CmdId)(0), // 0: proto.GetPlayerAskFriendListRsp.CmdId
	(*GetPlayerAskFriendListRsp)(nil),    // 1: proto.GetPlayerAskFriendListRsp
	(*FriendBrief)(nil),                  // 2: proto.FriendBrief
}
var file_GetPlayerAskFriendListRsp_proto_depIdxs = []int32{
	2, // 0: proto.GetPlayerAskFriendListRsp.ask_friend_list:type_name -> proto.FriendBrief
...
func file_GetPlayerAskFriendListRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetPlayerAskFriendListRsp_proto_enumTypes,
