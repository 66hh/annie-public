...
const (
	...
	GetSceneAreaReq_CMD_ID           GetSceneAreaReq_CmdId = 238
)
...
type GetSceneAreaReq struct {
	...
	BelongUid uint32 `protobuf:"varint,3,opt,name=belong_uid,json=belongUid,proto3" json:"belong_uid,omitempty"`
}
...
var file_GetSceneAreaReq_proto_rawDesc = []byte{
	...
	0x0a, 0x62, 0x65, 0x6c, 0x6f, 0x6e, 0x67, 0x5f, 0x75, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xee, 0x01, 0x1a, 0x02, 0x10, 0x01,
