...
type BattlePassMissionUpdateNotify struct {
	...
	MissionList []*BattlePassMission `protobuf:"bytes,6,rep,name=mission_list,json=missionList,proto3" json:"mission_list,omitempty"`
}
...
var file_BattlePassMissionUpdateNotify_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70,
