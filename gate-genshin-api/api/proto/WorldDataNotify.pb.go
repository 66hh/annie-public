...
type WorldDataNotify struct {
	...
	WorldPropMap map[uint32]*PropValue `protobuf:"bytes,3,rep,name=world_prop_map,json=worldPropMap,proto3" json:"world_prop_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_WorldDataNotify_proto_rawDesc = []byte{
	...
	0x70, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x70, 0x72,
