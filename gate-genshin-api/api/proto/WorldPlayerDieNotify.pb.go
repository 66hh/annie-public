...
const (
	...
	WorldPlayerDieNotify_CMD_ID           WorldPlayerDieNotify_CmdId = 296
)
...
type WorldPlayerDieNotify struct {
	...
	DieType          PlayerDieType                 `protobuf:"varint,9,opt,name=die_type,json=dieType,proto3,enum=proto.PlayerDieType" json:"die_type,omitempty"`
	MurdererEntityId uint32                        `protobuf:"varint,14,opt,name=murderer_entity_id,json=murdererEntityId,proto3" json:"murderer_entity_id,omitempty"`
}
...
type WorldPlayerDieNotify_GadgetId struct {
	GadgetId uint32 `protobuf:"varint,11,opt,name=gadget_id,json=gadgetId,proto3,oneof"`
}
...
var file_WorldPlayerDieNotify_proto_rawDesc = []byte{
	...
	0x0b, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x08, 0x67, 0x61, 0x64, 0x67, 0x65, 0x74, 0x49,
	0x64, 0x12, 0x2f, 0x0a, 0x08, 0x64, 0x69, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10,
	...
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xa8, 0x02, 0x1a, 0x02, 0x10, 0x01, 0x42,
