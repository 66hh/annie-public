...
const (
	...
	WeaponAwakenReq_CMD_ID           WeaponAwakenReq_CmdId = 642
)
...
type WeaponAwakenReq struct {
	...
	ItemGuid         uint64            `protobuf:"varint,3,opt,name=item_guid,json=itemGuid,proto3" json:"item_guid,omitempty"`
	AffixLevelMap    map[uint32]uint32 `protobuf:"bytes,2,rep,name=affix_level_map,json=affixLevelMap,proto3" json:"affix_level_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_WeaponAwakenReq_proto_rawDesc = []byte{
	...
	0x12, 0x1b, 0x0a, 0x09, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x67, 0x75, 0x69, 0x64, 0x18, 0x03, 0x20,
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x57,
	...
	0x82, 0x05, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f,
