...
type ReliquaryDecomposeReq struct {
	...
	GuidList    []uint64 `protobuf:"varint,15,rep,packed,name=guid_list,json=guidList,proto3" json:"guid_list,omitempty"`
}
...
var file_ReliquaryDecomposeReq_proto_rawDesc = []byte{
	...
	0x09, 0x67, 0x75, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x04,
