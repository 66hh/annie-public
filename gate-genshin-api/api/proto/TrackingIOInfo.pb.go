...
type TrackingIOInfo struct {
	...
	Rydevicetype string `protobuf:"bytes,4,opt,name=rydevicetype,proto3" json:"rydevicetype,omitempty"`
	ClientTz     string `protobuf:"bytes,5,opt,name=client_tz,json=clientTz,proto3" json:"client_tz,omitempty"`
	CurrentCaid  string `protobuf:"bytes,6,opt,name=current_caid,json=currentCaid,proto3" json:"current_caid,omitempty"`
	CachedCaid   string `protobuf:"bytes,7,opt,name=cached_caid,json=cachedCaid,proto3" json:"cached_caid,omitempty"`
}
...
var file_TrackingIOInfo_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x72, 0x79, 0x64, 0x65,
	...
	0x5f, 0x63, 0x61, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x75, 0x72,
	0x72, 0x65, 0x6e, 0x74, 0x43, 0x61, 0x69, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x63, 0x68,
	0x65, 0x64, 0x5f, 0x63, 0x61, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63,
