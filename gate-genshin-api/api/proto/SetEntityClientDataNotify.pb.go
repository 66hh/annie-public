...
const (
	...
	SetEntityClientDataNotify_CMD_ID           SetEntityClientDataNotify_CmdId = 3375
)
...
type SetEntityClientDataNotify struct {
	...
	EntityClientData *EntityClientData `protobuf:"bytes,1,opt,name=entity_client_data,json=entityClientData,proto3" json:"entity_client_data,omitempty"`
}
...
var file_SetEntityClientDataNotify_proto_rawDesc = []byte{
	...
	0xaf, 0x1a, 0x1a, 0x02, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f,
