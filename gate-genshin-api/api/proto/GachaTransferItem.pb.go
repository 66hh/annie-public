...
type GachaTransferItem struct {
	...
	Item              *ItemParam `protobuf:"bytes,8,opt,name=item,proto3" json:"item,omitempty"`
	IsTransferItemNew bool       `protobuf:"varint,13,opt,name=is_transfer_item_new,json=isTransferItemNew,proto3" json:"is_transfer_item_new,omitempty"`
}
...
var file_GachaTransferItem_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x24, 0x0a, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x18, 0x08,
	...
	0x5f, 0x6e, 0x65, 0x77, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x69, 0x73, 0x54, 0x72,
