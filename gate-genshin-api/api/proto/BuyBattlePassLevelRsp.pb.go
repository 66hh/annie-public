...
type BuyBattlePassLevelRsp struct {
	...
	BuyLevel uint32 `protobuf:"varint,6,opt,name=buy_level,json=buyLevel,proto3" json:"buy_level,omitempty"`
}
...
var file_BuyBattlePassLevelRsp_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x65, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x62, 0x75, 0x79, 0x4c,
