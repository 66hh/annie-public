...
type QueryPathRsp struct {
	...
	QueryStatus QueryPathRsp_PathStatusType `protobuf:"varint,5,opt,name=query_status,json=queryStatus,proto3,enum=proto.QueryPathRsp_PathStatusType" json:"query_status,omitempty"`
	Corners     []*Vector                   `protobuf:"bytes,12,rep,name=corners,proto3" json:"corners,omitempty"`
}
...
var file_QueryPathRsp_proto_rawDesc = []byte{
	...
	0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x51, 0x75,
...
var file_QueryPathRsp_proto_depIdxs = []int32{
	...
	2, // 1: proto.QueryPathRsp.corners:type_name -> proto.Vector
