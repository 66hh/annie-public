...
type GetGachaInfoRsp struct {
	...
	KKHCOFPEMNJ   uint32       `protobuf:"varint,7,opt,name=KKHCOFPEMNJ,proto3" json:"KKHCOFPEMNJ,omitempty"`
	LCPFDBAGIEC   bool         `protobuf:"varint,9,opt,name=LCPFDBAGIEC,proto3" json:"LCPFDBAGIEC,omitempty"`
}
...
func (x *GetGachaInfoRsp) GetKKHCOFPEMNJ() uint32 {
	if x != nil {
		return x.KKHCOFPEMNJ
	}
	return 0
}

func (x *GetGachaInfoRsp) GetLCPFDBAGIEC() bool {
	if x != nil {
		return x.LCPFDBAGIEC
	}
	return false
}
...
var file_GetGachaInfoRsp_proto_rawDesc = []byte{
	...
	0xcc, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x47, 0x61, 0x63, 0x68, 0x61, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47,
	...
	0x5f, 0x72, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x67,
	0x61, 0x63, 0x68, 0x61, 0x52, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x4b,
	0x48, 0x43, 0x4f, 0x46, 0x50, 0x45, 0x4d, 0x4e, 0x4a, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x4b, 0x4b, 0x48, 0x43, 0x4f, 0x46, 0x50, 0x45, 0x4d, 0x4e, 0x4a, 0x12, 0x20, 0x0a, 0x0b,
	0x4c, 0x43, 0x50, 0x46, 0x44, 0x42, 0x41, 0x47, 0x49, 0x45, 0x43, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0b, 0x4c, 0x43, 0x50, 0x46, 0x44, 0x42, 0x41, 0x47, 0x49, 0x45, 0x43, 0x42, 0x0a,
