...
type TakeBattlePassMissionPointReq struct {
	...
	MissionIdList []uint32 `protobuf:"varint,7,rep,packed,name=mission_id_list,json=missionIdList,proto3" json:"mission_id_list,omitempty"`
}
...
var file_TakeBattlePassMissionPointReq_proto_rawDesc = []byte{
	...
	0x18, 0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49,
