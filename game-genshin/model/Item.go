...
func (p *Player) GetVirtualItemProp(itemId uint32) (isVirtualItem bool, prop uint16) {
	...
	switch itemId {
	case 106:
		return true, playerPropertyConst.PROP_PLAYER_RESIN
	case 107:
		return true, playerPropertyConst.PROP_PLAYER_LEGENDARY_KEY
	case 201:
		return true, playerPropertyConst.PROP_PLAYER_HCOIN
	case 202:
		return true, playerPropertyConst.PROP_PLAYER_SCOIN
	case 203:
		return true, playerPropertyConst.PROP_PLAYER_MCOIN
	case 204:
		return true, playerPropertyConst.PROP_PLAYER_HOME_COIN
	default:
		return false, 0
	}
}
