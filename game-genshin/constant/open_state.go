...
func GetOpenStateConst() (r *OpenState) {
	r = new(OpenState)
	r.OPEN_STATE_NONE = 0
	r.OPEN_STATE_PAIMON = 1
	r.OPEN_STATE_PAIMON_NAVIGATION = 2
	r.OPEN_STATE_AVATAR_PROMOTE = 3
	r.OPEN_STATE_AVATAR_TALENT = 4
	r.OPEN_STATE_WEAPON_PROMOTE = 5
	r.OPEN_STATE_WEAPON_AWAKEN = 6
	r.OPEN_STATE_QUEST_REMIND = 7
	r.OPEN_STATE_GAME_GUIDE = 8
	r.OPEN_STATE_COOK = 9
	r.OPEN_STATE_WEAPON_UPGRADE = 10
	r.OPEN_STATE_RELIQUARY_UPGRADE = 11
	r.OPEN_STATE_RELIQUARY_PROMOTE = 12
	r.OPEN_STATE_WEAPON_PROMOTE_GUIDE = 13
	r.OPEN_STATE_WEAPON_CHANGE_GUIDE = 14
	r.OPEN_STATE_PLAYER_LVUP_GUIDE = 15
	r.OPEN_STATE_FRESHMAN_GUIDE = 16
	r.OPEN_STATE_SKIP_FRESHMAN_GUIDE = 17
	r.OPEN_STATE_GUIDE_MOVE_CAMERA = 18
	r.OPEN_STATE_GUIDE_SCALE_CAMERA = 19
	r.OPEN_STATE_GUIDE_KEYBOARD = 20
	r.OPEN_STATE_GUIDE_MOVE = 21
	r.OPEN_STATE_GUIDE_JUMP = 22
	r.OPEN_STATE_GUIDE_SPRINT = 23
	r.OPEN_STATE_GUIDE_MAP = 24
	r.OPEN_STATE_GUIDE_ATTACK = 25
	r.OPEN_STATE_GUIDE_FLY = 26
	r.OPEN_STATE_GUIDE_TALENT = 27
	r.OPEN_STATE_GUIDE_RELIC = 28
	r.OPEN_STATE_GUIDE_RELIC_PROM = 29
	r.OPEN_STATE_COMBINE = 30
	r.OPEN_STATE_GACHA = 31
	r.OPEN_STATE_GUIDE_GACHA = 32
	r.OPEN_STATE_GUIDE_TEAM = 33
	r.OPEN_STATE_GUIDE_PROUD = 34
	r.OPEN_STATE_GUIDE_AVATAR_PROMOTE = 35
	r.OPEN_STATE_GUIDE_ADVENTURE_CARD = 36
	r.OPEN_STATE_FORGE = 37
	r.OPEN_STATE_GUIDE_BAG = 38
	r.OPEN_STATE_EXPEDITION = 39
	r.OPEN_STATE_GUIDE_ADVENTURE_DAILYTASK = 40
	r.OPEN_STATE_GUIDE_ADVENTURE_DUNGEON = 41
	r.OPEN_STATE_TOWER = 42
	r.OPEN_STATE_WORLD_STAMINA = 43
	r.OPEN_STATE_TOWER_FIRST_ENTER = 44
	r.OPEN_STATE_RESIN = 45
	r.OPEN_STATE_LIMIT_REGION_FRESHMEAT = 47
	r.OPEN_STATE_LIMIT_REGION_GLOBAL = 48
	r.OPEN_STATE_MULTIPLAYER = 49
	r.OPEN_STATE_GUIDE_MOUSEPC = 50
	r.OPEN_STATE_GUIDE_MULTIPLAYER = 51
	r.OPEN_STATE_GUIDE_DUNGEONREWARD = 52
	r.OPEN_STATE_GUIDE_BLOSSOM = 53
	r.OPEN_STATE_AVATAR_FASHION = 54
	r.OPEN_STATE_PHOTOGRAPH = 55
	r.OPEN_STATE_GUIDE_KSLQUEST = 56
	r.OPEN_STATE_PERSONAL_LINE = 57
	r.OPEN_STATE_GUIDE_PERSONAL_LINE = 58
	r.OPEN_STATE_GUIDE_APPEARANCE = 59
	r.OPEN_STATE_GUIDE_PROCESS = 60
	r.OPEN_STATE_GUIDE_PERSONAL_LINE_KEY = 61
	r.OPEN_STATE_GUIDE_WIDGET = 62
	r.OPEN_STATE_GUIDE_ACTIVITY_SKILL_ASTER = 63
	r.OPEN_STATE_GUIDE_COLDCLIMATE = 64
	r.OPEN_STATE_DERIVATIVE_MALL = 65
	r.OPEN_STATE_GUIDE_EXITMULTIPLAYER = 66
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_BUILD = 67
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_REBUILD = 68
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_CARD = 69
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_MONSTER = 70
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_MISSION_CHECK = 71
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_BUILD_SELECT = 72
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_CHALLENGE_START = 73
	r.OPEN_STATE_GUIDE_CONVERT = 74
	r.OPEN_STATE_GUIDE_THEATREMACHANICUS_MULTIPLAYER = 75
	r.OPEN_STATE_GUIDE_COOP_TASK = 76
	r.OPEN_STATE_GUIDE_HOMEWORLD_ADEPTIABODE = 77
	r.OPEN_STATE_GUIDE_HOMEWORLD_DEPLOY = 78
	r.OPEN_STATE_GUIDE_CHANNELLERSLAB_EQUIP = 79
	r.OPEN_STATE_GUIDE_CHANNELLERSLAB_MP_SOLUTION = 80
	r.OPEN_STATE_GUIDE_CHANNELLERSLAB_POWER = 81
	r.OPEN_STATE_GUIDE_HIDEANDSEEK_SKILL = 82
	r.OPEN_STATE_GUIDE_HOMEWORLD_MAPLIST = 83
	r.OPEN_STATE_GUIDE_RELICRESOLVE = 84
	r.OPEN_STATE_GUIDE_GGUIDE = 85
	r.OPEN_STATE_GUIDE_GGUIDE_HINT = 86
	r.OPEN_STATE_CITY_REPUATION_MENGDE = 800
	r.OPEN_STATE_CITY_REPUATION_LIYUE = 801
	r.OPEN_STATE_CITY_REPUATION_UI_HINT = 802
	r.OPEN_STATE_CITY_REPUATION_INAZUMA = 803
	r.OPEN_STATE_SHOP_TYPE_MALL = 900
	r.OPEN_STATE_SHOP_TYPE_RECOMMANDED = 901
	r.OPEN_STATE_SHOP_TYPE_GENESISCRYSTAL = 902
	r.OPEN_STATE_SHOP_TYPE_GIFTPACKAGE = 903
	r.OPEN_STATE_SHOP_TYPE_PAIMON = 1001
	r.OPEN_STATE_SHOP_TYPE_CITY = 1002
	r.OPEN_STATE_SHOP_TYPE_BLACKSMITH = 1003
	r.OPEN_STATE_SHOP_TYPE_GROCERY = 1004
	r.OPEN_STATE_SHOP_TYPE_FOOD = 1005
	r.OPEN_STATE_SHOP_TYPE_SEA_LAMP = 1006
	r.OPEN_STATE_SHOP_TYPE_VIRTUAL_SHOP = 1007
	r.OPEN_STATE_SHOP_TYPE_LIYUE_GROCERY = 1008
	r.OPEN_STATE_SHOP_TYPE_LIYUE_SOUVENIR = 1009
	r.OPEN_STATE_SHOP_TYPE_LIYUE_RESTAURANT = 1010
	r.OPEN_STATE_SHOP_TYPE_INAZUMA_SOUVENIR = 1011
	r.OPEN_STATE_SHOP_TYPE_NPC_TOMOKI = 1012
	r.OPEN_ADVENTURE_MANUAL = 1100
	r.OPEN_ADVENTURE_MANUAL_CITY_MENGDE = 1101
	r.OPEN_ADVENTURE_MANUAL_CITY_LIYUE = 1102
	r.OPEN_ADVENTURE_MANUAL_MONSTER = 1103
	r.OPEN_ADVENTURE_MANUAL_BOSS_DUNGEON = 1104
	r.OPEN_STATE_ACTIVITY_SEALAMP = 1200
	r.OPEN_STATE_ACTIVITY_SEALAMP_TAB2 = 1201
	r.OPEN_STATE_ACTIVITY_SEALAMP_TAB3 = 1202
	r.OPEN_STATE_BATTLE_PASS = 1300
	r.OPEN_STATE_BATTLE_PASS_ENTRY = 1301
	r.OPEN_STATE_ACTIVITY_CRUCIBLE = 1400
	r.OPEN_STATE_ACTIVITY_NEWBEEBOUNS_OPEN = 1401
	r.OPEN_STATE_ACTIVITY_NEWBEEBOUNS_CLOSE = 1402
	r.OPEN_STATE_ACTIVITY_ENTRY_OPEN = 1403
	r.OPEN_STATE_MENGDE_INFUSEDCRYSTAL = 1404
	r.OPEN_STATE_LIYUE_INFUSEDCRYSTAL = 1405
	r.OPEN_STATE_SNOW_MOUNTAIN_ELDER_TREE = 1406
	r.OPEN_STATE_MIRACLE_RING = 1407
	r.OPEN_STATE_COOP_LINE = 1408
	r.OPEN_STATE_INAZUMA_INFUSEDCRYSTAL = 1409
	r.OPEN_STATE_FISH = 1410
	r.OPEN_STATE_GUIDE_SUMO_TEAM_SKILL = 1411
	r.OPEN_STATE_GUIDE_FISH_RECIPE = 1412
	r.OPEN_STATE_HOME = 1500
	r.OPEN_STATE_ACTIVITY_HOMEWORLD = 1501
	r.OPEN_STATE_ADEPTIABODE = 1502
	r.OPEN_STATE_HOME_AVATAR = 1503
	r.OPEN_STATE_HOME_EDIT = 1504
	r.OPEN_STATE_HOME_EDIT_TIPS = 1505
	r.OPEN_STATE_RELIQUARY_DECOMPOSE = 1600
	r.OPEN_STATE_ACTIVITY_H5 = 1700
	r.OPEN_STATE_ORAIONOKAMI = 2000
	r.OPEN_STATE_GUIDE_CHESS_MISSION_CHECK = 2001
	r.OPEN_STATE_GUIDE_CHESS_BUILD = 2002
	r.OPEN_STATE_GUIDE_CHESS_WIND_TOWER_CIRCLE = 2003
	r.OPEN_STATE_GUIDE_CHESS_CARD_SELECT = 2004
	r.OPEN_STATE_INAZUMA_MAINQUEST_FINISHED = 2005
	r.OPEN_STATE_PAIMON_LVINFO = 2100
	r.OPEN_STATE_TELEPORT_HUD = 2101
	r.OPEN_STATE_GUIDE_MAP_UNLOCK = 2102
	r.OPEN_STATE_GUIDE_PAIMON_LVINFO = 2103
	r.OPEN_STATE_GUIDE_AMBORTRANSPORT = 2104
	r.OPEN_STATE_GUIDE_FLY_SECOND = 2105
	r.OPEN_STATE_GUIDE_KAEYA_CLUE = 2106
	r.OPEN_STATE_CAPTURE_CODEX = 2107
	r.OPEN_STATE_ACTIVITY_FISH_OPEN = 2200
	r.OPEN_STATE_ACTIVITY_FISH_CLOSE = 2201
	r.OPEN_STATE_GUIDE_ROGUE_MAP = 2205
	r.OPEN_STATE_GUIDE_ROGUE_RUNE = 2206
	r.OPEN_STATE_GUIDE_BARTENDER_FORMULA = 2210
	r.OPEN_STATE_GUIDE_BARTENDER_MIX = 2211
	r.OPEN_STATE_GUIDE_BARTENDER_CUP = 2212
	r.OPEN_STATE_GUIDE_MAIL_FAVORITES = 2400
	r.OPEN_STATE_GUIDE_POTION_CONFIGURE = 2401
	r.OPEN_STATE_GUIDE_LANV2_FIREWORK = 2402
	r.OPEN_STATE_LOADINGTIPS_ENKANOMIYA = 2403
	r.OPEN_STATE_MICHIAE_CASKET = 2500
	r.OPEN_STATE_MAIL_COLLECT_UNLOCK_RED_POINT = 2501
	r.OPEN_STATE_LUMEN_STONE = 2600
	r.OPEN_STATE_GUIDE_CRYSTALLINK_BUFF = 2601
	return r
}
